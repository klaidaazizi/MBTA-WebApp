...
import PinnedRoutes from "./nav-components/pinned-routes";
            ...
            <ul className='nav nav-tabs mt-2 mb-2'>
                ...
                <li className="nav-item">
                    <Link to="/profile/liked-posts"
                          className={`nav-link ${location.pathname.indexOf('liked-posts') >= 0 ? 'active':''}`}>
                        Liked Posts</Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                    <Link to="/profile/conductor-likes"
                          className={`nav-link ${location.pathname.indexOf('aconductor-likes') >= 0 ? 'active':''}`}>
                        Liked conductors</Link>
                </li>

                <li className="nav-item">
                    <Link to="/profile/pinned-routes"
                          className={`nav-link ${location.pathname.indexOf('pinned-routes') >= 0 ? 'active':''}`}>
                        Pinned Routes</Link>
                </li>
            </ul>
