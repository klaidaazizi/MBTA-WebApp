...
const RapidTransitRouteItem = ({rtRoute}) => {
    ...
    const saveProfile = () => {
        try {
            ...
            conductor.currentRouteConducting = `/home/rapid-transit/${rtRoute.id}/${routeName}`;
    ...
    return(
        <div>
            <li className='list-group-item rt-route-color '>
                ...
                {/*        <div>*/}
                {/*<span className='col-6  rt-route-test-color d-none d-xxl-block'>{rtRoute.attributes.direction_destinations[0]}</span>*/}
                {/*        </div>*/}
                {/*        <div>*/}
                {/*<span className='col-6  rt-route-test-color d-none d-xxl-block'>{rtRoute.attributes.direction_destinations[1]}</span>*/}
                {/*    </div>*/}
                    </div>
                </Link>
            </div>
