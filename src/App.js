          ...
          <div className="container" >
              <Routes>
                  <Route path="/"
                      ...
                      <Route path="search/rapid-transit/:routeId/stop/detail/:stopId"
